Я глупый программист, пишущий или изучающий что-либо на `Java`, `C#`, `Kotlin`, `F#`, `Rust`, `С/C++`, `Go`, `V`, `PHP`, `Python`, `Processing`, `HTML`, `CSS`, `JS/TS`, `Ruby`, `Haskell`, `AutoIt`, `AutoHotkey`
